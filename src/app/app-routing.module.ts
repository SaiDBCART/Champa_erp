...
import { AssignEmployeeComponent } from './components/pages/counters/assign-employee/assign-employee.component';
const routes: Routes = [
  ...
  { path: "AssignedCounter", component: AssignEmployeeComponent }
